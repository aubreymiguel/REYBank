...
error_reporting(E_ERROR | E_PARSE);
    ...
    $trans2 = $trans->b_transact($tType, $tAmount, $tProcessed_by, $checkImg, $checkNum, $transactNum, $uBranch);
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-7 mx-auto">
            <div class="card">
                <div class="card-header" style="font-size: 14px">Withdraw</div>
                <div class="card-body">
                ...
                ?>
                    ...
                    <form action=" " method="POST" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <table class="table table-striped" style="font-size: 12px;">
                            ...
                            <input type="hidden" class="form-control" name="tType" id="tType" value="Withdraw">
